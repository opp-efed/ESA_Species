...
def ZonalHist(inZoneData, zoneField, inValueRaster, outTable, outpath, path):
    ...
    arcpy.env.overwriteOutput = True
    arcpy.AddMessage("Running Statistics...")
    arcpy.gp.ZonalHistogram(inZoneData, zoneField, inValueRaster, outTable)
    print 'completed Zone Hist table loocated at {0}'.format(outTable)
    code = 100
    return code
    # except:
    # print "FAILED"
