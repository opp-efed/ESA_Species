...
col_reindex = ['EntityID', 'comname', 'sciname', 'family', 'status_text', 'pop_abbrev', 'Group', 'Des_CH',
               ...
               'Vegetables and Ground Fruit_CarbarylBuffer', 'Carbaryl_ActionArea_NoDrift','Carbaryl_ActionArea_Ground',
               'Carbaryl_ActionArea_Aerial',
...
collapses_dict = {
    ...
    'Carbaryl_ActionArea_NoDrift': ['AK_Carbaryl_AA_0', 'AS_Carbaryl_AA_0', 'CNMI_Carbaryl_AA_0', 'CONUS_Carbaryl_AA_0',
                            'GU_Carbaryl_AA_0', 'HI_Carbaryl_AA_0', 'PR_Carbaryl_AA_0', 'VI_Carbaryl_AA_0'],
    'Carbaryl_ActionArea_Ground': ['AK_Carbaryl_AA_305', 'AS_Carbaryl_AA_305', 'CNMI_Carbaryl_AA_305', 'CONUS_Carbaryl_AA_305',

                            'GU_Carbaryl_AA_305', 'HI_Carbaryl_AA_305', 'PR_Carbaryl_AA_305', 'VI_Carbaryl_AA_305'],
    'Carbaryl_ActionArea_Aerial': ['AK_Carbaryl_AA_765', 'AS_Carbaryl_AA_765', 'CNMI_Carbaryl_AA_765', 'CONUS_Carbaryl_AA_765',
...
def step_1_ED(row):
    if row['EntityID'] in NE_Extinct:
        ...
        if row['Carbaryl_ActionArea_Aerial'] == 0:
            return 'NE-Overlap and NE-DD'
        elif row['Carbaryl_ActionArea_Aerial'] > 0:
