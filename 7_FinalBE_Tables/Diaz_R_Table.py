...
LAA_AA_error = ['821', '113', '965', '3020', '10228', '6303', '1129', '5956', '9403', '10233', '770', '799',
                ...
                '1179', '839', '726', '728', '3728', '622', '9469', '1193', '1194', '1216', '1311', '4680', '10587',
                '10594', '1194', '1216', '9407']
...
collapses_dict = {
    ...
    'OrchardsVineyards_MaxBuffer': ['CONUS_Orchards and Vineyards_765', 'HI_Ag_765',
                                     'PR_Ag_765', 'CNMI_Ag_765', 'AK_Ag_765', 'GU_Ag_765',
                                     'VI_Ag_765', 'AS_Ag_765'],
    'Nurseries_MaxBuffer': ['CONUS_Nurseries_765', 'AK_Nurseries_765', 'HI_Nurseries_765',
                             'PR_Nurseries_765', 'VI_Nurseries_765'],
...
def summary_table(step1, step2, groups):
    ...
    df_summary = df_summary.reindex(columns=['WoE Summary Group', 'NE', 'May Affect', 'NLAA', 'LAA'])
