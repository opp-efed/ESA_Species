...
in_location_species = r'L:\ESA\Results\diazinon\Tabulated_PolBoundaries\Range\Agg_Layers'
in_locations_states = 'L:\ESA\Results\diazinon\Tabulated_PolBoundaries\PoliticalBoundaries\Agg_Layers\States'
...
in_results_sp = in_location_species + os.sep + 'SumSpecies' + os.sep + st_cnty
...
list_folders = os.listdir(in_results_sp)

for folder in list_folders:
    list_csv = os.listdir(in_results_sp + os.sep + folder)
    ...
    csv = list_csv[0]
    state_df = pd.read_csv(in_locations_states + os.sep + csv)
    ...
    species_df = pd.read_csv(in_results_sp + os.sep + folder + os.sep + csv)
