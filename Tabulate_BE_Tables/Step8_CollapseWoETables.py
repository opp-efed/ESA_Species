...
# inlocation
in_table = r'E:\Tabulated_NewComps\FinalBETables\CriticalHabitat\BE_Intervals\CH_AllUses_BE_20170105.csv'
...
out_csv = temp_folder + os.sep + 'CH_Collapsed_WoE_20170105.csv'
sp_index_cols = 12
