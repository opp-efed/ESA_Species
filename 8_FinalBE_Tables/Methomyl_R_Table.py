...
col_reindex = ['EntityID', 'comname', 'sciname', 'family', 'status_text', 'pop_abbrev', 'Group', 'Des_CH',
               ...
               'Fly bait_Buffer', 'Methomyl_ActionArea_NoDrift','Methomyl_ActionArea_Ground',
               'Methomyl_ActionArea_Aerial', 'Step 1 ED', 'Step 1 ED Comment', 'Step 2 ED','Step 2 ED Comment',
               'Fly bait Only', 'Drift Only-NonFly bait'
               ]
...
collapses_dict = {
    ...
    'Methomyl_ActionArea_NoDrift': ['AK_Methomyl_AA_0', 'AS_Methomyl_AA_0', 'CNMI_Methomyl_AA_0', 'CONUS_Methomyl_AA_0',
                            'GU_Methomyl_AA_0', 'HI_Methomyl_AA_0', 'PR_Methomyl_AA_0', 'VI_Methomyl_AA_0'],
    'Methomyl_ActionArea_Ground': ['AK_Methomyl_AA_305', 'AS_Methomyl_AA_305', 'CNMI_Methomyl_AA_305', 'CONUS_Methomyl_AA_305',

                            'GU_Methomyl_AA_305', 'HI_Methomyl_AA_305', 'PR_Methomyl_AA_305', 'VI_Methomyl_AA_305'],
    'Methomyl_ActionArea_Aerial': ['AK_Methomyl_AA_765', 'AS_Methomyl_AA_765', 'CNMI_Methomyl_AA_765', 'CONUS_Methomyl_AA_765',
...
def step_1_ED(row):
    if row['EntityID'] in NE_Extinct:
        ...
        if row['Methomyl_ActionArea_Aerial'] == 0:
            return 'NE-Overlap and NE-DD'
        elif row['Methomyl_ActionArea_Aerial'] > 0:
