...
col_reindex = ['EntityID', 'comname', 'sciname', 'family', 'status_text', 'pop_abbrev', 'Group', 'Des_CH',
               ...
               'Chlorpyrifos_ActionArea_Aerial','Diazinon_ActionArea_Aerial', 'Malathion_ActionArea_Ground',
               'Chlorpyrifos_ActionArea_Ground', 'Diazinon_ActionArea_Ground',
               'Malathion_ActionArea_noDrift', 'Chlorpyrifos_ActionArea_noDrift', 'Diazinon_ActionArea_noDrift',
...
collapses_dict = {
    ...
    'Diazinon_ActionArea_Ground': ['CONUS_Diazinon_AA_305', 'AK_Diazinon_AA_305',
                                       'CNMI_Diazinon_AA_305',
                                       'GU_Diazinon_AA_305', 'HI_Diazinon_AA_305', 'PR_Diazinon_AA_305',
                                       'VI_Diazinon_AA_305',
                                       'AS_Diazinon_AA_305'],
    'Diazinon_ActionArea_Aerial': ['CONUS_Diazinon_AA_765', 'AK_Diazinon_AA_765',
                                       'CNMI_Diazinon_AA_765',
                                       'GU_Diazinon_AA_765', 'HI_Diazinon_AA_765', 'PR_Diazinon_AA_765',
                                       'VI_Diazinon_AA_765',
                                       'AS_Diazinon_AA_765'],
    'Diazinon_ActionArea_noDrift': ['CONUS_Diazinon_AA_0', 'AK_Diazinon_AA_0', 'CNMI_Diazinon_AA_0',
                                        'GU_Diazinon_AA_0', 'HI_Diazinon_AA_0', 'PR_Diazinon_AA_0',
                                        'VI_Diazinon_AA_0',
                                        'AS_Diazinon_AA_0'],
