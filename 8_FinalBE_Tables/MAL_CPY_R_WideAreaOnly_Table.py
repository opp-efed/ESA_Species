...
out_csv = temp_folder + os.sep + 'R_FinalBE_WideAreaOnly_20170109.csv'
sp_index_cols = 12
...
#     'Developed': ['AK_Developed_0', 'AS_Developed_0', 'CNMI_Developed_0', 'CONUS_Developed_0',
...
#                   'VI_Nurseries_0'],
#     'Open Space Developed': ['AK_Open Space Developed_0', 'AS_Open Space Developed_0',
...
#     'Rice': ['CONUS_Rice_0'],
#     'Right of Way': ['AK_Right of Way_0', 'AS_Right of Way_0', 'CNMI_Right of Way_0', 'CONUS_Right of Way_0',
