...
l48_BE_sum_path = root_path + os.sep + chemical_name + os.sep + file_type+os.sep +folder_path
nl48_BE_sum_path = root_path + os.sep + chemical_name + os.sep + file_type+os.sep +folder_path
on_off_species =[]
...
for group in ['min','max','avg']:
    for bound in ['Lower', 'Upper', 'Uniform']:
        ...
        if hab:
            ...
            chemical_name = chemical_name +"_HadAdj"
        else:
            chem_name = chemical_name
