...
def main():
    path = r'C:\Users\JConno02\Environmental Protection Agency (EPA)\Endangered Species Pilot Assessments - OverlapTables\ChemicalTables\Draft Propazine'
    ...
    none_use_cols = ['EntityID', 'Common Name', 'Scientific Name', 'Status', 'pop_abbrev', 'family', 'Lead Agency',
                     ...
                     'Min in Species range','Max in species range','Uniform','STATEFP','STATE', 'Migratory_YesNo',
                     'Critical_Habitat_YesNo' ]
