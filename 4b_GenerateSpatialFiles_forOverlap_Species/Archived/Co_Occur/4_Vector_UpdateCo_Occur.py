...
ch_overlaplist  = 'C:\Users\Admin\Documents\Jen\Workspace\MasterOverlap\CriticalHabitat.gdb\MasterUse_20150903_CH_20151209'
overlaplist= 'C:\Users\Admin\Documents\Jen\Workspace\MasterOverlap\Range.gdb\MasterUse_20150903_R_20151209'
...
with open(folderDict, 'rU') as inputFile:
    ...
    for line in inputFile:
        ...
        for fc in functions.fcs_in_workspace(finalGDB):
            ...
            fc_entlist = current_update.keys()
            print fc_entlist# get a list of keys in dict
            ...
            if CHcheck == 'CH':
                ...
                with arcpy.da.UpdateCursor(overlaplist,["EntityID", columnID, "RAcres", "RRange", "FileName"]) as cursor:
