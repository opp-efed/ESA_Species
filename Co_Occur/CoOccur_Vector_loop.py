...
fc = 'C:\Users\Admin\Documents\Jen\Workspace\ESA_Species\BySpeciesGroup\ForCoOccur\Results\NonL48\GU\Corals\GU_CoralsVector.gdb\GU_R_Corals_NL48_NADAlbers_201501116_SJ'
#C:\Users\Admin\Documents\Jen\Workspace\ESA_Species\BySpeciesGroup\ForCoOccur\Results\NonL48\GU\Corals\GU_CoralsVector.gdb\GU_R_Corals_NL48_NADAlbers_201501116_SJ

#

VectorLocation = r"C:\Users\Admin\Documents\Jen\Workspace\UseSites\VectorUses.gdb"
#VectorLocation = r"C:\Users\Admin\Documents\Jen\Workspace\UseSites\VectorUseWGS.gdb"
...
if fileType== 'R_' and region == 'L48only':
    outpath_base = 'C:\Users\Admin\Documents\Jen\Workspace\ESA_Species\BySpeciesGroup\ForCoOccur\Results'+ os.sep + group
    ...
    outpath_base = 'C:\Users\Admin\Documents\Jen\Workspace\ESA_Species\BySpeciesGroup\ForCoOccur\Results\CriticalHabitat\L48'+ os.sep + group
    outpath_final = outpath_base + os.sep+ fileType +  group + 'Vector.gdb'
    outpath = outpath_base + os.sep + "Working.gdb"

elif fileType== 'R_' and region != 'L48only':
    outpath_base = 'C:\Users\Admin\Documents\Jen\Workspace\ESA_Species\BySpeciesGroup\ForCoOccur\Results\NonL48'+ os.sep +region+ os.sep + group
    outpath_final = outpath_base + os.sep+ region+ '_'+ group + 'Vector.gdb'
    outpath = outpath_base + os.sep + "Working.gdb"

elif fileType== 'CH_' and region != 'L48only' :
    outpath_base = 'C:\Users\Admin\Documents\Jen\Workspace\ESA_Species\BySpeciesGroup\ForCoOccur\Results\CriticalHabitat\NL48'+ os.sep +region+ os.sep + group
