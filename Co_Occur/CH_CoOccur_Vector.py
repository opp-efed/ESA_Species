...
fc = 'C:\Users\Admin\Documents\Jen\Workspace\ESA_Species\BySpeciesGroup\ForCoOccur\Results\CriticalHabitat\L48\Clams\CH_VectorClams.gdb\Lower48Only_CH_Clams_L48_AlbersEqualArea_vectoruses'
...
outpath_final = outpath_base + os.sep+ fileType + 'Vector' + group + '.gdb'
outpath = outpath_base + os.sep + "Working.gdb"

lyrPath = outpath_base + os.sep +'lyr'

VectorLocation = r"C:\Users\Admin\Documents\Jen\Workspace\UseSites\CONUS_VectorUses.gdb"

flag = 'CH_'+group + region
