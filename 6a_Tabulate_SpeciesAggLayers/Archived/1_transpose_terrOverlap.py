...
csvFolder = r'L:\Workspace\ESA_Species\Step3\ToolDevelopment\TerrestrialGIS\Results_NewComps\L48\Agg_layers\NonAg\Range'
outFolder = r'L:\Workspace\ESA_Species\Step3\ToolDevelopment\TerrestrialGIS\Tabulated_NewComps\FederalLands\L48\Range\Transposed_Spray'
...
for folder in out_folders:
    ...
    for csv in list_csv:
        ...
        group_df_by_zone_sum['ZoneID'] = group_df_by_zone_sum['ZoneID'].map(lambda x: x.replace('VALUE_', '')).astype(
            str)
