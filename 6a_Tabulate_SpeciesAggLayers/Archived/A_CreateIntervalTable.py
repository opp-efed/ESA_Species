...
in_folder = r'L:\Workspace\ESA_Species\Step3\ToolDevelopment\TerrestrialGIS\Tabulated_NewComps\FederalLands\NL48\Range\Merge_WholeRange'
out_location = r'L:\Workspace\ESA_Species\Step3\ToolDevelopment\TerrestrialGIS\Tabulated_NewComps\FederalLands\NL48\Range'
...
out_csv = out_location + os.sep + 'R_NL48_SprayInterval_'+ (date)+'_WholeRange.csv'

master_list = 'C:\Users\JConno02\Documents\Projects\ESA\MasterLists\MasterListESA_June2016_20170216.xlsx'
col_included = ['EntityID', 'Group', 'comname', 'sciname', 'status_text', 'Des_CH', 'CH_GIS','Source of Call final BE-Range',
                'WoE Summary Group','Source of Call final BE-Range']
