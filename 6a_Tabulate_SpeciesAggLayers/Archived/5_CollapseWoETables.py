...
# TODO USE INPUT table from step 1 to automate the collapsing dict
# TODO removed drift cols for AA specific cols, do we still want these?
# inlocation
...
list_final_uses = use_lookup['FinalColHeader'].values.tolist()
