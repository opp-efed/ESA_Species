...
in_table = r'L:\Workspace\ESA_Species\Step3\ToolDevelopment\TerrestrialGIS\Tabulated_NewComps\Range_test\SprayInterval_IntStep_30_MaxDistance_1501\R_SprayInterval_20170816_FullRange.csv'
master_col = ['EntityID', 'Common Name', 'Scientific Name', 'Status', 'pop_abbrev', 'family', 'Lead Agency',
