...
outfolder = 'J:\Workspace\ESA_Species\Range\WGS_Albers\\topo'

midGBD = 'J:\Workspace\ESA_Species\Range\WGS_Albers\\topo\middle.gdb'

prjFolder = 'J:\Workspace\projections'
prjFile = "J:\Workspace\projections\WGS_1984_Albers.prj"

gdblist = ['Simplified_topoCorrected.gdb', 'Topo_FailedSimple.gdb']
skiplist = []
