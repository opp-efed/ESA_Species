...
current_master = r'C:\Users\JConno02\Documents\Projects\ESA\Bins\Update_Fall2016\MasterBinUpdated_20161108.csv'
long_bins = r'C:\Users\JConno02\Documents\Projects\ESA\Bins\Update_Fall2016\ArchivedData\LongBins_20161115.csv'
woe_csv = r'C:\Users\JConno02\Documents\Projects\ESA\Bins\Update_Fall2016\species woe taxa.csv'
col_included = ['lead_agency', 'Group', 'comname', 'EntityID', 'sciname', 'status_text']
col_index_bins = {'lead_agency': 1, 'Group': 2, 'comname': 4, 'EntityID': 5, 'sciname': 6, 'status_text': 7}
            ...
            try:
                ...
                for col in col_included:
                    ...
                    if value_master != value_bin:
                        ...
                        updated.append(entid + "_" + col + "_" + value_bin + "_" + value_master)
                    else:
                        pass

                huc_2 = long_bin_df.iloc[row, 3]
                if huc_2.startswith('22'):
                    long_bin_df.iloc[row, 3] = 20
                ...
                if len(woe_groups_df) == 0:
                    ...
                    long_bin_df.iloc[row, 15] = woe_group_a

                else:
                    woe_group_a = woe_groups_df.iloc[0, 3]  # 14
                    woe_group_b = woe_groups_df.iloc[1, 3]
                    long_bin_df.iloc[row, 15] = woe_group_a
                    long_bin_df.iloc[row, 16] = woe_group_b
