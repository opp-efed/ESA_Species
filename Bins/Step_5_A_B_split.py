...
# input a_b split table generated by split_HUC2_A_B and splitHUC2_A_B_Summarize

# When loading in tables that have huc12 the leading 0 is often dropped.  Must set column as str and updated to include
# the 0
...
entity_id_col_s = 'ENTITYID'  # column header species EntityID in_split
...
out_table = table_folder + os.sep + 'LongBins_unfiltered_AB_' + str(date) + '.csv'
...
def load_data(split, cross, bins_long):
    ...
    split_df_cols = update_columns(str(entity_id_col_s), str(entity_id_col_c), split_df_cols)
