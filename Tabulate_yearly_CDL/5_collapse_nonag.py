...
inFolder = r'L:\Workspace\ESA_Species\Step3\ToolDevelopment\TerrestrialGIS\Using_BE_Compfiles\Range\YearlyCDL_results\Merge'
final_folder = r'L:\Workspace\ESA_Species\Step3\ToolDevelopment\TerrestrialGIS\Using_BE_Compfiles\Range\YearlyCDL_results\Collapse'
...
final_cols = ['EntityID',	'Group',	'comname',	'sciname',	'status_text',	'Des_CH',	'acres', 'Corn', 'Cotton', 'Rice', 'Soybeans', 'Wheat','Vegetables and Ground Fruit',
...
for csv in list_csv:
    ...
    out_df = in_df[['EntityID',	'Group',	'comname',	'sciname',	'status_text',	'Des_CH',	'acres']]

    out_df.columns = ['EntityID',	'Group',	'comname',	'sciname',	'status_text',	'Des_CH',	'acres']
