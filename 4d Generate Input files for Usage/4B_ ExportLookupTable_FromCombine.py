...
look_up_fcs = r'D:\Species\UnionFile_Spring2020\Range\Lookup_R_Clipped_Union_CntyInter_HUC2ABInter_20200427'
# files combine with additonal data from step 4
in_combine_grids = r'D:\Species\UnionFile_Spring2020\Range\SpComp_UsageHUCAB_byProjection\Grid_byProjections_Combined'
# outlocation for lookup
out_location = r'D:\Species\UnionFile_Spring2020\Range\LookUp_Grid_byProjections_Combined_20200427'
skip_region = []
...
for folder in list_dir:
    if folder.split("_")[0] not in skip_region:  # skips region that were already completed
