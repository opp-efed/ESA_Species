...
collapses_dict = {
    ...
    'Managed Forests': ['CONUS_Managed Forests_0', 'AK_Managed Forests_0', 'CNMI_Managed Forests_0',
                        'GU_Managed Forests_0', 'HI_Managed Forests_0', 'PR_Managed Forests_0', 'VI_Managed Forests_0'],
    ...
    'Culitivated': ['CONUS_Cultivated_0', 'HI_Ag_0', 'PR_Ag_0', 'AK_Ag_0', 'CNMI_Ag_0', 'GU_Ag_0', 'VI_Ag_0'],
    'Rangeland': ['CONUS_Cattle Eartag_0', 'AK_Cattle Eartag_0', 'CNMI_Cattle Eartag_0', 'GU_Cattle Eartag_0',
                  'HI_Cattle Eartag_0', 'PR_Cattle Eartag_0', 'VI_Cattle Eartag_0'],
    'Non Cultivated': ['CONUS_Non Cultivated_0', 'AK_Non Cultivated_0', 'CNMI_Non Cultivated_0', 'GU_Non Cultivated_0',
                       'HI_Non Cultivated_0', 'PR_Non Cultivated_0', 'VI_Non Cultivated_0'],
    ...
    'Orchards and Vineyards_CarbarylBuffer': ['CONUS_Orchards and Vineyards_765', 'AK_Ag_765', 'CNMI_Ag_765',
                                              'GU_Ag_765', 'HI_Ag_765', 'PR_Ag_765', 'VI_Ag_765', ],
    ...
    'Open Space Developed_CarbarylBuffer': ['CONUS_Open Space Developed_765', 'AK_Open Space Developed_765',
                                            'CNMI_Open Space Developed_765', 'GU_Open Space Developed_765',
                                            'HI_Open Space Developed_765', 'PR_Open Space Developed_765',
                                            'VI_Open Space Developed_765'],
    ...
    'Non Cultivated_CarbarylBuffer': ['CONUS_Non Cultivated_765', 'AK_Non Cultivated_765',
                                      ...
                                      'PR_Non Cultivated_765', 'VI_Non Cultivated_765'],
