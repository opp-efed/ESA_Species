...
# inputs
masterlist = 'C:\Users\JConno02\Documents\Projects\ESA\MasterLists\April2016\csv\MasterListESA_June2016_20160819.csv'
infolder = 'J:\Workspace\ESA_Species\Range\HUC12'  # folder or GDB
addition_gdb_filename = '_HUC12_Dissolve'  # if the gdbs are not just the species group
# Species groups that do not need to be run
skiplist = []

# cols from master that should be included use to pop att table
col_included = ['EntityID', 'comname', 'sciname', 'spcode', 'vipcode', 'status_text']
final_fields = ['FileName', 'EntityID', 'NAME', 'Name_sci', 'SPCode', 'VIPCode', 'Status']  # in order
