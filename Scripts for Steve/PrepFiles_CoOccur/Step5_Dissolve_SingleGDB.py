...
dissolveFields = ['NAME', 'Name_sci', 'SPCode', 'VIPCode', 'FileName', 'EntityID','Status']

ingdb = 'J:\Workspace\ESA_Species\Range\HUC12\Insects_HUC12.gdb'

outGDB = 'J:\Workspace\ESA_Species\Range\HUC12\Insects_HUC12_Dissolve.gdb'
# sp groups to skip
skipgroup = []
