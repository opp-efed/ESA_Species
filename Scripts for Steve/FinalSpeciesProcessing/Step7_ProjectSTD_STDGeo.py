...
middlegdb = r'J:\Workspace\ESA_Species\temp.gdb'
...
ReProjectGDB = "CH_polygon_20160809_Reprojected"
CSVName = "CH_polygon_20160809_Reprojected"
    ...
    if ORGdsc.spatialReference.Type == "Projected":
        ...
        if ORGsr.GCS.datumName == "D_North_American_1983":
            ...
            if not arcpy.Exists(outfc):
                ...
                print str(fc) + " already exists"
        elif ORGsr.GCS.datumName == 'GCS_North_American_1983_HARN':
