...
masterlist = 'C:\Users\JConno02\Documents\Projects\ESA\MasterLists\April2016\csv' \
             '\MasterListESA_June2016_20160725.csv'
...
if Range:
    ...
    intersect_fc = r'C:\WorkSpace\ESA_Species\FinalBE_EucDis_CoOccur\CriticalHabitat\scratch.gdb\Regions_dissolve'
    ...
    temp_regional = r'C:\Workspace\ESA_Species\FinalBE_EucDis_CoOccur\Range\regions' \
                    r'\R_SpGroupComposite_Regional_STDprj_20160816.gdb'
    ...
    temp_prj = r'C:\Workspace\ESA_Species\FinalBE_EucDis_CoOccur\Range\regions' \
               r'\R_SpGroupComposite_InterProjection_20160816.gdb'
    final_prj_comp = r'C:\Workspace\ESA_Species\FinalBE_EucDis_CoOccur\Range\regions' \
                     r'\R_SpGroupComposite_ProjectedtRegion_20160816.gdb'
# input values and workspaces for critical habitat
else:
    # in folder with species group composite with all species unprojections and location of region feature class
    infc_gdb = 'C:\WorkSpace\ESA_Species\FinalBE_EucDis_CoOccur\CriticalHabitat\CH_SpGroupComposite.gdb'
    intersect_fc = r'J:\Workspace\ESA_Species\ForCoOccur\Composites\GDB\ArchivedComposites\20160503\CompositesForClip' \
                   r'\Boundaries.gdb\Regions_dissolve'

    # out locations of the species group composites intersected with region
    out_explode_location = r'C:\Workspace\ESA_Species\FinalBE_EucDis_CoOccur\CriticalHabitat\regions' \
                           r'\CH_SpGroupComposite_ExplodeComp_20160816.gdb'
    out_explode_location_final = r'C:\Workspace\ESA_Species\FinalBE_EucDis_CoOccur\CriticalHabitat\regions' \
                                 r'\CH_SpGroupComposite_ExplodeCompFinal_20160816.gdb'
    out_clip_location = r'C:\Workspace\ESA_Species\FinalBE_EucDis_CoOccur\CriticalHabitat\regions' \
                        r'\CH_SpGroupComposite_clipComp_20160816.gdb'
    out_intersect_location = r'C:\Workspace\ESA_Species\FinalBE_EucDis_CoOccur\CriticalHabitat\regions' \
                             r'\CH_SpGroupComposite_IntersectRegion_20160816.gdb'
    out_spatial_join_location = r'C:\Workspace\ESA_Species\FinalBE_EucDis_CoOccur\CriticalHabitat\regions' \
                                r'\CH_SpGroupComposite_spatialjoin_Region_20160816.gdb'
    out_Dissolve_location = r'C:\Workspace\ESA_Species\FinalBE_EucDis_CoOccur\CriticalHabitat\regions' \
                            r'\CH_SpGroupComposite_DissolveRegion_20160816.gdb'
    out_Dissolve_location_final = r'C:\Workspace\ESA_Species\FinalBE_EucDis_CoOccur\CriticalHabitat\regions' \
                                  r'\CH_SpGroupComposite_DissolveRegion_Final_20160816.gdb'
    DissolveFields = ['FileName', 'EntityID', 'NAME', 'Name_sci', 'SPCode', 'VIPCode', 'Status', 'Region']

    temp_regional = r'C:\Workspace\ESA_Species\FinalBE_EucDis_CoOccur\CriticalHabitat\regions' \
                    r'\CH_SpGroupComposite_Regional_STDprj_20160816.gdb'
    # Projection information for the different regional projections
    temp_prj = r'C:\Workspace\ESA_Species\FinalBE_EucDis_CoOccur\CriticalHabitat\regions' \
               r'\CH_SpGroupComposite_InterProjection_20160816.gdb'
    final_prj_comp = r'C:\Workspace\ESA_Species\FinalBE_EucDis_CoOccur\CriticalHabitat\regions' \
                     r'\CH_SpGroupComposite_ProjectedtRegion_20160816.gdb'
# file suffix for each step
explode_suffix = '_ExplodeRegion_20160816'
spatial_join_suffix = '_SpatialJoinRegion_20160816'
dissolve_suffix = '_DissolveRegion_20160816'
clipped_suffix = '_ClippedLand_Region_20160816'
intersect_suffix = '_IntersectRegion_20160816'
...
def explode_polygons(in_location, out_location, previous_suffix, suffix):
    ...
    for fc in fc_list:
        ...
        try:
            ...
            print 'Deleted partial FC{0}'.format(out_feature)
