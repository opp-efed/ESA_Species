...
# out table
out_csv = 'C:\Workspace\ESA_Species\FinalBE_EucDis_CoOccur\Range\R_Acres_by_region.csv'
# in GDB with projected comp files, regional and world projection for full spatial file
inGDB_list = [
    r'C:\WorkSpace\ESA_Species\FinalBE_EucDis_CoOccur\Range\regions\R_SpGroupComposite_ProjectedtRegion_20160816.gdb',
...
col_included = ['EntityID', 'Group', 'comname', 'sciname', 'status_text', 'Range_Filename', 'Des_CH', 'CH_GIS',
                'CH_Filename']
# regional fc
regional_fc = r'C:\WorkSpace\ESA_Species\FinalBE_EucDis_CoOccur\CriticalHabitat\scratch.gdb\Regions_dissolve'
