...
in_table = 'C:\Workspace\ESA_Species\FinalBE_EucDis_CoOccur\Range\R_Acres_by_region.csv'
out_csv = 'C:\Workspace\ESA_Species\FinalBE_EucDis_CoOccur\Range\R_ConvertedAcres_SqMiles_' + str(
