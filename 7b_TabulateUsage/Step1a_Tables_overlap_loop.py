...
max_drift = '792'
l48_BE_sum_path = "L:\Workspace\StreamLine\ESA\Tabulated_TabArea_HUCAB_Usage\Carbaryl\Range\SprayInterval_IntStep_30_MaxDistance_1501\census"
l48_BE_sum_table = "R_Uniform_census_AllUses_BE_L48_SprayInterval_Full Range_avg_20190501.csv"

nl48_BE_sum_path = "L:\Workspace\StreamLine\ESA\Tabulated_TabArea_HUCAB_Usage\Carbaryl\Range\SprayInterval_IntStep_30_MaxDistance_1501\census"
nl48_BE_sum_table = "R_Uniform_census_AllUses_BE_NL48_SprayInterval_Full Range_avg_20190501.csv"
...
for group in ['min','max','avg']:
    for bound in ['Lower', 'Upper', 'Uniform']:
        table= l48_BE_sum_table.split("_")[0] +"_"+bound+"_"+l48_BE_sum_table.split("_")[2]+"_"+l48_BE_sum_table.split("_")[3]+"_"+l48_BE_sum_table.split("_")[4]+"_"+l48_BE_sum_table.split("_")[5]+"_"+l48_BE_sum_table.split("_")[6]+"_"+l48_BE_sum_table.split("_")[7]+"_"+group+"_"+l48_BE_sum_table.split("_")[9]
        l48_BE_sum = l48_BE_sum_path +os.sep+table
        table_nl= nl48_BE_sum_table.split("_")[0] +"_"+bound+"_"+nl48_BE_sum_table.split("_")[2]+"_"+ nl48_BE_sum_table.split("_")[3]+"_"+nl48_BE_sum_table.split("_")[4]+"_"+nl48_BE_sum_table.split("_")[5]+ "_"+nl48_BE_sum_table.split("_")[6]+"_"+nl48_BE_sum_table.split("_")[7]+"_"+group+"_"+nl48_BE_sum_table.split("_")[9]
        nl48_BE_sum = nl48_BE_sum_path +os.sep+table_nl
        print l48_BE_sum
        print nl48_BE_sum
        find_file_type = l48_BE_sum_table
        ...
        out_path = out_location + os.sep + chemical_name +os.sep+"Summarized Tables"+ os.sep +'Step 1'+os.sep+group
